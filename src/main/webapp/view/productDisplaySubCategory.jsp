					...
					<c:if test="${subCategory != null}">
						...
						<div class="resultsAltMainContent">
							<div class="boxContent">
								...
								<c:choose>							
									<c:when test="${subCategory.products != null && fn:length(subCategory.products) > 0 }">
										<table id="productsByCategoryTable" width="100%">
											<c:forEach items="${subCategory.products}" varStatus="childGridRow" var="product">
												...
												<c:if test="${(childGridRow.index + 1) % 3 == 0 || (childGridRow.index + 1) == fn:length(subCategory.products)}">
													</tr>
													<tr>
